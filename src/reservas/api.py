...
app = FastAPI(title="TicketFast - Reservas", lifespan=lifespan)
...
def crear_reserva(
    ...
    nueva_reserva = repo.guardar_reserva(
        evento_id, reserva.cliente_email, reserva.zona, reserva.cantidad
    )
